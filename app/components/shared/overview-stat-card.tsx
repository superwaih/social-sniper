...
const StatCard: FC<StatCardProps> = ({ title, value, subtitle, isLoading }) => (
  <div className="relative border-[#779CBF38] space-y-6 h-[158px] rounded-[6px] pt-[10px] px-[19px] bg-[#06131B] border overflow-hidden">
    ...
    {isLoading ? (
      <div className="font-grok flex gap-3 items-center animate-pulse">
        <div className="h-[48px] w-[120px] bg-[#1a2733] rounded-md" />
        <div className="h-[20px] w-[60px] bg-[#1a2733] rounded-md pt-6" />
      </div>
    ) : (
