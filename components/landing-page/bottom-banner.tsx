      ...
      >
        ...
        >
          <motion.div variants={buttonVariants}>
            <Link href="/">
              <motion.div
                className="px-8 md:px-12 py-3 bg-[#ff4c02] [font-family:'Space_Grotesk',Helvetica] font-normal text-white text-[16.3px] tracking-[-0.65px] rounded cursor-pointer relative overflow-hidden"
                whileHover={{
                  scale: 1.05,
          ...
          <motion.div variants={buttonVariants}>
            <Link href="/">
              <motion.div
                className="gradient-border px-4 md:px-8 py-2 md:py-3 [font-family:'Space_Grotesk',Helvetica] gradient-text font-medium text-[16.3px] cursor-pointer relative overflow-hidden"
                whileHover={{
                  scale: 1.05,
                  transition: { duration: 0.2 },
                }}
